...
import { Plus, Linkedin, SortAsc, SortDesc } from "lucide-react";
...
export default function LinkedInPage() {
  ...
  // Fetch content items filtered for LinkedIn
  ...
  return (
    ...
    } description="Manage your LinkedIn posts and professional content">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Fill in the details to create a new LinkedIn post.
                      </DialogDescription>
                    </DialogHeader>
                    <ContentForm onSubmit={handleCreateContent} workflows={workflows} defaultContentType="linkedin" />
                  </DialogContent>
                </Dialog>
              </div>
            </div>
