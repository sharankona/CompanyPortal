...
import { Plus, Facebook, SortAsc, SortDesc } from "lucide-react";
...
export default function FacebookPage() {
  ...
  // Fetch content items filtered for Facebook
  ...
  return (
    ...
    } description="Manage your Facebook posts and page content">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                      <DialogTitle>Create New Facebook Post</DialogTitle>
                      <DialogDescription>
                        Fill in the details to create a new Facebook post.
                      </DialogDescription>
                    </DialogHeader>
                    <ContentForm onSubmit={handleCreateContent} workflows={workflows} defaultContentType="facebook" />
                  </DialogContent>
                </Dialog>
              </div>
            </div>
