...
export default function TwitterPage() {
  ...
  return (
    <DashboardShell title="X (Twitter) Content" description="Manage your Twitter/X posts and content">
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <Twitter className="h-6 w-6 text-black" />
            <div className="text-sm text-muted-foreground">
              Manage your X (Twitter) posts and content
            </div>
          </div>
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              <DialogHeader>
                <DialogTitle>Create New Twitter Content</DialogTitle>
                <DialogDescription>Fill in the details to create a new Twitter post.</DialogDescription>
              </DialogHeader>
