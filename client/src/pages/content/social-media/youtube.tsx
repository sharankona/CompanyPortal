...
import { Plus, Youtube, SortAsc, SortDesc } from "lucide-react";
...
export default function YouTubePage() {
  ...
  // Fetch content items filtered for YouTube
  ...
  return (
    ...
    } description="Manage your YouTube videos and channel content">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                      <DialogTitle>Create New YouTube Video</DialogTitle>
                      <DialogDescription>
                        Fill in the details to create a new YouTube video.
                      </DialogDescription>
                    </DialogHeader>
                    <ContentForm onSubmit={handleCreateContent} workflows={workflows} defaultContentType="youtube" />
                  </DialogContent>
                </Dialog>
              </div>
            </div>
