...
import { Plus, Instagram, SortAsc, SortDesc } from "lucide-react";
...
export default function InstagramPage() {
  ...
  // Fetch content items filtered for Instagram
  ...
  return (
    ...
    } description="Manage your Instagram posts and stories">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[600px]">
                    ...
                    <ContentForm onSubmit={handleCreateContent} workflows={workflows} defaultContentType="instagram" />
                  </DialogContent>
                </Dialog>
              </div>
            </div>
